...
| ------------------------ | --------------------- | ----------- |
| 3D Skin Layers           | 1.5.4                 | Cosmetic    |
| Advancement Info         | 1.4                   | Technical   |
| Advancement Plaques      | 1.4.11                | Cosmetic    |
| Ambient Environment      | 11.0.0.1              | Cosmetic    |
| Ambient Sounds           | 5.2.22                | Cosmetic    |
| Appleskin                | 2.5.0                 | Survival    |
| Auth Me                  | 7.0.2                 | Technical   |
| Bad Packets              | 0.4.1                 | Required    |
| Better F3                | 7.0.1                 | Technical   |
| Better FPS Distance      | 3.9                   | Performance |
| Better Mount HUD         | 1.2.2                 | Survival    |
| Better Ping Display      | 1.1.1                 | QoL         |
| Better Statistics Screen | 2.10.3                | QoL         |
| Better Third Person      | 1.9.0                 | QoL         |
| Blur                     | 3.1.0                 | Cosmetic    |
| Bobby                    | 5.0.1                 | Technical   |
| C²ME                     | 0.2.0 Alpha 10.98     | Performance |
| Camera Overhaul          | 1.4.0                 | Cosmetic    |
| Camera Utils             | 1.0.5                 | QoL         |
| Capes                    | 1.5.2                 | Cosmetic    |
| Carpet                   | 1.4.112               | Technical   |
| Carpet Extra             | 1.4.115               | Technical   |
| Carpet Fixes             | 1.16.1                | Technical   |
| Carpet TCTC Addition     | 2.2.201 8009659       | Technical   |
| Carpet TIS Addition      | 1.50.1                | Technical   |
| Chat Patches             | 201.5.5               | QoL         |
| CIT Resewn               | 1.1.3                 | Cosmetic    |
| Clear Despawn            | 1.1.13                | Survival    |
| Client Side Noteblocks   | 2.6                   | QoL         |
| Cloth Config             | 11.1.106              | Required    |
| Command Block IDE        | 0.4.3                 | Technical   |
| Continuity               | 3.0.0 Beta 3          | Cosmetic    |
| Controlling              | 12.0.2                | QoL         |
...
| EMI                      | 1.0.19                | Survival    |
| EMI Trades               | 1.2.0                 | Survival    |
| Emoji Type               | 2.2.1                 | Cosmetic    |
| Enhanced Block Entities  | 0.9                   | Performance |
| Entity Model Features    | 0.2.13                | Cosmetic    |
| Entity Texture Features  | 4.5.1                 | Cosmetic    |
| Entity Culling           | 1.6.2                 | Performance |
| Essential                | 1.2.2                 | QoL         |
| Essential Dependencies   | N/A                   | Required    |
| Extreme Sound Muffler    | 3.39                  | QoL         |
| Fabric API               | 0.87.0                | Required    |
| Fabric Language Kotlin   | 1.10.10 Kotlin 1.9.10 | Required    |
| Fabrishot                | 1.10.0                | QoL         |
| Falling Leaves           | 1.15.2                | Cosmetic    |
| Fast Animations          | 1.6                   | Performance |
| Fast Random              | 1.3                   | Performance |
| Ferrite Core             | 6.0.0                 | Performance |
| First Person             | 2.2.3                 | Cosmetic    |
| Forge Config API         | 8.0.0                 | Required    |
| Freecam                  | 1.2.1                 | Technical   |
| Fuel Info                | 1.0.4                 | Survival    |
| Iceberg                  | 1.1.15                | Required    |
| Immediately Fast         | 1.1.28                | Performance |
| Indium                   | 1.0.25                | Required    |
| Inventory Control Tweaks | 1.3.27                | Survival    |
| Inventory Profiles Next  | 1.10.7                | Survival    |
| Iris                     | 1.6.8                 | Cosmetic    |
| Item Swapper             | 0.5.3                 | QoL         |
| Jade                     | 11.5.1                | Survival    |
| Krypton                  | 0.2.3                 | Performance |
| Lamb Dynamic Lights      | 2.3.1                 | Cosmetic    |
| Lazy DFU                 | 0.1.3                 | Performance |
| Lazy Language Loader     | 0.3.3                 | Performance |
| Legendary Tooltips       | 1.4.4                 | Cosmetic    |
| libIPN                   | 4.0.0                 | Required    |
| libjf                    | 3.12.5                | Required    |
| Litematica               | 0.15.3                | Technical   |
| Litematica Server Paster | 1.1.2                 | Technical   |
| Lithium                  | 0.11.2                | Performance |
| Magic Lib                | 0.7.364 85d9866       | Required    |
| Make Bubbles Pop         | 0.2.0                 | Cosmetic    |
| malilib                  | 0.16.1                | Required    |
| Memory Leak Fix          | 1.1.1                 | Performance |
| MiniHUD                  | 0.27.0                | Technical   |
| Mod Menu                 | 7.2.1                 | QoL         |
| More Culling             | 0.19.0                | Performance |
| More Roman Numerals      | 1.0.0                 | Cosmetic    |
| Mouse Tweaks             | 2.25                  | QoL         |
| No Chat Reports          | 2.2.2                 | QoL         |
| Not Enough Animations    | 1.6.4                 | Cosmetic    |
| Pick Up Notifier         | 8.0.0                 | Survival    |
| Presence Footsteps       | 1.9.0                 | Cosmetic    |
| Prism                    | 1.0.5                 | Required    |
| Puzzle Lib               | 8.0.24                | Required    |
| Reese's Sodium Options   | 1.6.5                 | QoL         |
| Remove Reload Screen     | 3.1.1                 | Technical   |
| Replay Mod               | 2.6.13                | Technical   |
| Replay Voice Chat        | 1.3.3                 | Technical   |
| Resourcify               | 1.1.3                 | Technical   |
| Searchables              | 1.0.1                 | Required    |
| Simple Health Bar        | 1.0.2                 | Survival    |
| Skin Swapper             | 3.1.4                 | QoL         |
| Slyde                    | 1.7.1                 | Technical   |
| Sodium                   | 0.5.2                 | Performance |
| Sodium Extra             | 0.5.1 Build 112       | Performance |
| Sound Physics Remastered | 1.1.2                 | Cosmetic    |
| Status Effect Bars       | 1.0.3                 | Cosmetic    |
| Vanilla Ice Cream Fix    | 1.1.7 Beta            | Performance |
| Viafabric Plus           | 2.8.5                 | Technical   |
| Visual Overhaul          | 5.0.1                 | Cosmetic    |
| Very Many Players        | 0.2.0 Beta 7.100      | Performance |
| Simple Voice Chat        | 2.4.22                | Technical   |
| Wavey Capes              | 1.4.0                 | Cosmetic    |
| Worldedit                | 7.2.15                | Technical   |
| Xaero's Minimap          | 23.6.3                | QoL         |
| Xaero's World Map        | 1.33.1                | QoL         |
| Yet Another Config Lib   | 3.1.0                 | Required    |
...
| Better Command Block UI               | 0.4.2       | Replaced with Command Block IDE         |
...
| Plasmovoice                           | 2.3.28      | Replaced with Simple Voice Chat         |
| Sodium/Rubidium Occlusion Culling Fix | 1.2.0       | Fixed in Sodium 5.0.0                   |
| Chunks Fade In                        | 1.0.3       | No support for Sodium 0.5.2             |
| Fancy Menu                            | 2.14.7      | Pointless                               |
| Load My Resources                     | 1.0.4       | Used for Fancy Menu                     |
| Screenshot to Clipboard               | 1.0.9       | Functionality in Essential              |
| VT Downloader                         | 2.0.7       | Glitchy                                 |
| Fast Random                           | 1.3         | Base Game 1.20.2                        |
| Chat Heads                            | N/A         | Not functional unless player in range   |
| Just Enough Items                     | N/A         | Thought to be necessary for EMI. Is not |
